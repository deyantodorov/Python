...
def cir(n_years=10, n_scenarios=1, a=0.05, b=0.03, sigma=0.05, steps_per_year=12, r_0=None):
    ...
    shock = np.random.normal(0, scale=np.sqrt(
        dt), size=(num_steps, n_scenarios))
...
def bond_price(maturity, principal=100, coupon_rate=0.03, coupons_per_year=12, discount_rate=0.03):
    """
    Price a bond based on a bond parameters maturity, principal, coupon rate and coupons_per_year
    and a the prevailing discount rate
    """
...
def funding_ratio(assets, liabilities, r):
    """
    Computes the funding ration of a series of liabilites, based on an interest rate and current value of assets
    """
